...
const SERVICES_DATA = [
  {
    image: serviceImage1,
    text:
      'We provide the user with a wide range of Electric Vehicle charging stations in India.',
    heading: 'Fuel Up',
    path: '#',
  },
  {
    image: serviceImage2,
    text:
      'Our app is going to find you the real-time availability of the nearest charging station!',
    heading: 'Grab a Bite ',
    path: '#',
  },
  {
    image: serviceImage3,
    text:
      'Use our app to schedule the charging slot at whenever you want!',
