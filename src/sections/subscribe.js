...
const Subscribe = () => {
  return (
    <Box as="section" sx={styles.subscribe}>
      <Container>
        <Heading as="h3">We'd love to hear from you!</Heading>
        <Text as="p">
          Have a question about our service station? Been here before,and wish we had something specific? Send us a message,and we'll get back to you!
        </Text>
        <Text as ="p"> By subscribing with your mail, you will accept our privacy policy</Text>
       <Text as ="h3"> csselectricgo@gmail.com</Text>
